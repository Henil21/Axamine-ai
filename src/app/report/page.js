        ...
        <div className={styles.right}>
          ...
          <div className={styles.content}>
            ...
            <ol className={styles.list} type="1">
              ...
              <li className={styles.listHeading}>
                ...
                <ul>
                  <li>
                    The tumor exhibits increased density compared to surrounding
                    lung parenchyma.
                  </li>
                </ul>
              </li>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.para}>
              ...
              suspicious lung mass located in the upper lobe of the right lung.
              The irregular shape and indistinct margins raise concern for
              malignancy. Further evaluation through computed tomography (CT)
              imaging and biopsy is recommended for definitive diagnosis and
              treatment planning.
            </p>
          </div>
          <div className={styles.content}>
          ...
          <div className={styles.content}>
            ...
            <ul>
              <li>
              This report is based on the interpretation of the provided X-ray image. Clinical correlation and additional investigations are necessary for accurate diagnosis and treatment decisions.
                </li>
            </ul>
          </div>
          <div className={styles.buttons}>
            <button className={`${styles.btn} ${styles.demoBtn} buttonWithGradient`}>Download</button>
            <button className={`${styles.btn} buttonWithGradientBorder`}>Print</button>
        </div>
        </div>
      </section>
    </div>
